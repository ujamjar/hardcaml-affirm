...
(* OASIS_START *)
(* DO NOT EDIT (digest: a4ae42d23acc881d43bda0800771593e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Andy Ray"];
          homepage = Some "https://github.com/ujamjar/hardcaml-affirm";
          synopsis = "Verification tools for HardCaml";
          description =
            Some [OASISText.Para "Verification tools for HardCaml"];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Props"; "Transform_state"; "NuSMV"; "Bmc"; "Waves"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "hardcaml-affirm";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/ujamjar/hardcaml-affirm.git";
                      src_repo_browser =
                        Some "https://github.com/ujamjar/hardcaml-affirm";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "HardCamlAffirm"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = true; exec_main_is = "counter.ml"});
               Executable
                 ({
                     cs_name = "tx-state";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "tx_state.ml"});
               Executable
                 ({
                     cs_name = "sim";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "sim.ml"})
            ];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "i\226\206O4\030\192\233\1598\172\186\176'/\012";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
