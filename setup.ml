...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7f22bf0c2b7891902e2cfbadea6a73d2) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Props"; "Sat"; "Dimacs"; "NuSMV"; "Bmc"; "Waves"];
                      lib_pack = true;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "HardCamlAffirm"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.6";
     oasis_digest =
       Some "\246\004\151\163\238\197t\222\154/\213\206\210\192R\022";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
