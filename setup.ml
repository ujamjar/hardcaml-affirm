...
(* OASIS_START *)
(* DO NOT EDIT (digest: ba16fb7fa3bd032dd521406903886751) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("hardcaml", None)];
                   ...
                   {
                      lib_modules = ["Props"; "Sat"; "Dimacs"; "NuSMV"; "Bmc"];
                      lib_pack = true;
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "}6\140\253\206\127\152\231\135\159N>\213\242\151)";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
